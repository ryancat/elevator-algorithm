...
/***/ function(module, exports, __webpack_require__) {
	...
	var Elevator = function () {
	  function Elevator(_ref) {
	    ...
	    var currentLevel = _ref$currentLevel === undefined ? 0 : _ref$currentLevel;
	    var _ref$destLevel = _ref.destLevel;
	    var destLevel = _ref$destLevel === undefined ? 0 : _ref$destLevel;
	    var _ref$direction = _ref.direction;
	    var direction = _ref$direction === undefined ? Elevator.direction.up : _ref$direction;
	    var _ref$upList = _ref.upList;
	    var upList = _ref$upList === undefined ? [] : _ref$upList;
	    var _ref$downList = _ref.downList;
	    var downList = _ref$downList === undefined ? [] : _ref$downList;
	    var _ref$maxLevel = _ref.maxLevel;
	    var maxLevel = _ref$maxLevel === undefined ? Infinity : _ref$maxLevel;
	    var _ref$minLevel = _ref.minLevel;
	    var minLevel = _ref$minLevel === undefined ? 0 : _ref$minLevel;
	  ...
	  _createClass(Elevator, [{
	    ...
	    key: 'validateLevel',
	    value: function validateLevel(level) {
	...
	var randomAddLevel = function randomAddLevel(level) {
	
	  elevator.addLevel(level);
	
	  var randomTime = Math.floor(Math.random() * 10 * 1000);
	  var randomLevel = Math.floor(Math.random() * 10);
